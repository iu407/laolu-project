...
<p style="color: red;">提示：添加杂志；表单还需要修改</p>
		...
		<ul>
			<li >
				...
				<div><input type="text" name="jyid" id="jyid" value="001001"/></div>
			</li>
			<li >
			...
			<li>
				...
				<div><input type="text" name="goodsname" id="goodsname" value="青年一代"/></div>
			</li>
			<li>
				<div class='title'>价格：（长度8，保留2位。例如：###.##）</div>
				<div><input type="text" name="price" id="price" value="5.00"/></div>
			</li>
			<li>
				<div>详细描述：</div>
				<div><textarea name="detail" id="detail">青年一代</textarea></div>
			</li>
			<li>
				<div>是否销售：</div>
				<div>
